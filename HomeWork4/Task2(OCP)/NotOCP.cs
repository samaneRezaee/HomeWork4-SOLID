...
namespace HomeWork4.Task2_OPC_
{
    ...
    /// اگر بخواهیم شکل جدید را اضافه کنیم باید متد area را باز کنیم و تغییر بدهیم
    /// یعنی دقیقا برعکس کلاس نسبت به گسترش بسته است و نسبت به تغییر باز!
    /// 
    /// اگر بخواهیم مساحت شکلی دیگر مثلا مثلث را هم حساب کنیم 
